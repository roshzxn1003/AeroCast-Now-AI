...
export const MAJOR_INDIAN_CITIES: CityPreset[] = [
  ...
  { id: 'bengaluru', name: 'Bengaluru', state: 'Karnataka', lat: 12.9716, lng: 77.5946, stationName: 'Bengaluru DWR', dwrRadarName: 'Bengaluru Radar' },
  ...
  { id: 'ahmedabad', name: 'Ahmedabad', state: 'Gujarat', lat: 23.0225, lng: 72.5714, stationName: 'Jaipur DWR', dwrRadarName: 'Western DWR' },
  ...
  { id: 'jaipur', name: 'Jaipur', state: 'Rajasthan', lat: 26.9124, lng: 75.7873, stationName: 'Jaipur DWR', dwrRadarName: 'Jaipur DWR' },
];
